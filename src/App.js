...
class App extends Component{
  ...
  const apiUrl = `https://mgu9eqpsj4.execute-api.us-east-1.amazonaws.com/prod/bucket-prueba-despliegue-imagenes-nolambda-nodynamo/${encodeURIComponent(filename)}`;
